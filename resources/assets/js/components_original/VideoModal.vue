<template>
  <div>
    <play-button
      ...
      :options="{
        playButtonImage: options && options.playButtonImage && options.playButtonImage != '' ? options.playButtonImage : '',
        buttonText: options && options.buttonText && options.buttonText != '' ? options.buttonText : ''
      }"
    />
