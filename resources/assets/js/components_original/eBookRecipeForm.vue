<template>
  ...
  <div :class="{'inline': !useButton}" class="eBookForm">
    <button
      ...
      :class="[useButton ? 'btn-home primary account confirm' : 'font-bold hover:text-green-thrive']"
        ...
        <slide
          ...
          <div class="w-full">
            ...
            <form @submit.prevent="signUp" class="max-w-125 mx-auto">
              <div v-if="!customer">
                <input type="text" v-model="user.name" placeholder="|| 'eBookRecipeForm.placeholder_username' ||" required="required" class="placeholder-black" />
                <input type="text" v-model="user.email" placeholder="|| 'eBookRecipeForm.placeholder_email' ||" required="required" class="placeholder-black" />
              </div>
              ...
              <div class="mt-8 text-sm leading-snug">
                <div v-show="formError" class="mb-4 text-warning">|| 'eBookRecipeForm.form_error' ||</div>
                <div v-show="submitWarning" class="mb-4 text-warning">|| 'eBookRecipeForm.submit_warning' ||</div>
        ...
        <slide
          ...
          <div class="w-full">
            ...
            <div class="text-base md:text-lg lg:text-xl max-w-md mx-auto leading-snug font-normal">
              ...
              <template v-else>
                <p class="mb-8">|| 'eBookRecipeForm.default_final_message' ||</p>
              </template>
              <p>|| 'eBookRecipeForm.close_window_text' ||</p>
            </div>
          </div>
        </slide>
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      buttonText: {
        type: String,
        default: '|| 'eBookRecipeForm.default_button_text' ||'
      },
      linkText: {
        type: String,
        default: '|| 'eBookRecipeForm.default_link_text' ||'
      },
      finalMessage: {
        type: String
      },
